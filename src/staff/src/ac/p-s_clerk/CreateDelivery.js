...
import {createDelivery} from "../../api/psStaffApi";

async function onSubmit(maDonHang: string) {
    console.log("submit");

    await createDelivery(maDonHang)
...
class CreateDelivery extends React.Component {
    ...
    render() {
        return (
            <div>
                <Typography.Title level={3}>Tạo đơn hàng cần chuyển đến tay người nhận</Typography.Title>
                <div style={{
                    width: '50%',
                    display: 'flex',
                    alignContent: 'center',
