...
import {VAT, GTGT, UNIT_RATE_FILE, UNIT_RATE_BOX, API_URL} from "../../Util";
...
class CreateShipment extends React.Component{
        ...
        let info1 = (
            ...
            >
                ...
                <Input
                    ...
                    onChange={(e) => {
                        this.shipment.sender.name = e.target.value;
                    }}
                />
                <Input
                    ...
                    maxLength={11}
                    onChange={(e) => {
                        this.shipment.sender.phone = e.target.value;
                    }}
                />
                <Input.TextArea
                    placeholder="Địa chỉ"
                    prefix={<CarOutlined/>}
                    onChange={(e) => {
                        this.shipment.sender.address = e.target.value;
                    }}
                />
            </Space>
        );
        let info2 = (
            ...
            >
                ...
                <Input
                    ...
                    placeholder="Họ và tên" size={8} prefix={<UserOutlined/>}
                    onChange={(e) => {
                        this.shipment.receiver.name = e.target.value;
                    }}
                />
                <Input
                    placeholder="Số điện thoại" size={16} type={"tel"}
                    ...
                    maxLength={11}
                    onChange={(e) => {
                        this.shipment.receiver.phone = e.target.value;
                    }}
                />
                <Input.TextArea
                    placeholder="Địa chỉ"
                    prefix={<CarOutlined/>}
                    onChange={(e) => {
                        this.shipment.receiver.address = e.target.value;
                    }}
                />
            </Space>
        );
    ...
    async onConfirm2() {
        // await createShipment(this.shipment).then((data) => {
        //     console.log(data);
        //     this.shipment.id = data.id;
        // });
